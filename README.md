...
conv-26 한 편(발화 419 / QA 199)을 qwen3.5-9b-mlx로 완주한 결과.
전량 10편 baseline은 진행 예정 (아티팩트: `runs/smoke-local/`, 설정
스냅샷 포함 — 저장소에는 커밋되지 않는다):

| category | n | set_f1 | std_f1 | bleu1 |
|---|---|---|---|---|
| MULTI_HOP | 32 | 0.2756 | 0.2701 | 0.2352 |
| TEMPORAL | 37 | 0.3009 | 0.3009 | 0.2165 |
| OPEN_DOMAIN | 13 | 0.3043 | 0.3034 | 0.1634 |
| SINGLE_HOP | 70 | 0.3567 | 0.3548 | 0.3029 |
| ADVERSARIAL | 47 | 0.3696 | 0.3688 | 0.2985 |
| **OVERALL (1~4)** | 152 | **0.3215** | 0.3194 | 0.2557 |

ADVERSARIAL은 함정 오답 기준 채점이라 높을수록 나쁘다. 비용: 1,460 호출 /
88만 토큰 / 3.3h (ingest 1.4h + QA 1.9h, M4 24GB 로컬). 눈에 띄는 패턴:
temporal은 상대 시점("next month")을 세션 날짜로 앵커링하지 못하고,
adversarial은 관련 기억을 끌어와 자신 있게 오답한다 — 거절이 드물다.
